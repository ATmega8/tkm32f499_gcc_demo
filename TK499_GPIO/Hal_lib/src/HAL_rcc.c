...
void RCC_PLLConfig(uint32_t RCC_PLLSource, uint32_t RCC_PLLMul)
{
 ...
 if(RCC_PLLMul==RCC_PLLMul_2)
  ...
  {
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x00000004, 0x00000000,0x00000001);//Frclk*10/2
  }
...
void getSystemClock(RCC_ClocksTypeDef *RCC_ClocksStatus)
{
  ...
  RCC_ClocksStatus->HCLK_Frequency = sysclk / div;
  div = 1;
  ...
  RCC_ClocksStatus->PCLK1_Frequency = RCC_ClocksStatus->HCLK_Frequency / div;
  div = 1;
